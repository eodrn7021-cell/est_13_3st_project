    ...
    <Link className={styles.quick_menu_card} href={href}>
      ...
      <div className={styles.quick_menu_content}>
        ...
        <div className={styles.quick_menu_bottom}>
          {/* PC 설명 */}
          <p
            className={`kr_caption ${styles.quick_menu_description} ${styles.quick_menu_description_pc}`}
          >
            {description}
          </p>
          ...
          {/* 태블릿 설명 */}
          <p
            className={`kr_caption ${styles.quick_menu_description} ${styles.quick_menu_description_tablet}`}
          >
            {tabletDescription || description}
          </p>
