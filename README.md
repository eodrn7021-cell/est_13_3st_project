...
- [x] GitHub 협업 환경 설정
- [x] 브랜치·커밋·PR 규칙 정리
- [x] React·TypeScript 프로젝트 환경 구성
- [x] 폴더 구조 및 파일 네이밍 규칙 확정
- [x] 라우터와 공통 레이아웃 구성
- [x] 헤더·사이드바·모바일 하단 바 구현
- [x] 공통 버튼·입력창·태그 컴포넌트 제작
- [x] 공통 카드 컴포넌트 제작
- [x] 반응형 기본 스타일 적용
...
- [x] 추천 캐릭터 슬라이드 구현
- [x] 카테고리 및 인기 스토리 렌더링
- [x] 캐릭터 목록 및 상세 페이지 구현
- [x] 검색·태그·필터 기능 구현
- [x] 캐릭터 생성·수정·삭제 기능 구현
- [x] 로그인·회원가입 기능 구현
- [x] 마이페이지 및 캐릭터 관리 기능 구현
- [x] 데이터베이스 연동
